...
#   bin/drop_priv.sh $SNAP/usr/lib/postgresql/17/bin/psql
...
# evidence shows percona-postgresql-client-17 ships its tools ONLY under
# usr/lib/postgresql/17/bin/ with no /usr/bin/* pg_wrapper symlinks
